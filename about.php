...
<html>
	...
	<body>
		<div id="progress"></div>
		<nav class="navbar navbar-light" style = "background-color:orange;margin-bottom:2%;box-shadow: 3px 3px 5px;border-bottom:3px solid black;">
		...
		<div class = "col-lg-7 mcon m-auto">
			<h1 style = "color : purple;font-weight:bold;font-size:45px;padding-bottom:0px;padding-top:10px;margin-top:1px;text-shadow:1px 1px 2px black;" align = "center">About</h1>
			...
			<h1 style = "color : navy;font-weight:bold;padding-bottom:0px;padding-top:0px;margin-top:0px;text-shadow:1px 1px 2px black;">****************************************************</h1>
			<ol>
				<li>Online Exam Registration Portal helps the students in registering their Semester End Examination Subjects and fasttrack(backlogs)easily through online registration</li>
				<li>All the students details regarding the Exam Registration is maintained in a Database that can be accessed by Head of the Department Anywhere and Anytime.</li>
				<li>Loss of Data is minimized as the details is maintained in a Database.</li>
				<li>Students can fill the form through online by registering themselves.</li>
				<li>Admin can easily check the number of students who have registered and can Add, Edit or Update & Delete the subjects registered</li>
