...
<body>
    <div id="progress"></div>
    <!-- Navigation -->
    <nav class="navbar mnav navbar-expand-lg navbar-dark static-top" style="background-color:orange;padding:20px;border-bottom: 2px solid black;box-shadow: 3px 3px 5px black;">
        ...
        <form name="register" method="post" class="myform" action="" enctype="multipart/form-data">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td class="td1">
                        <input type="text" name="USN" autocomplete="off" placeholder="1BM20CS415" required />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="td1">
                        <input type="email" name="mail" autocomplete="off" placeholder="student.cs20@bmsce.ac.in" required />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="td1">
                        <input type="phone" autocomplete="off" name="phone" id="phone" placeholder="0123456789" />
                    </td>
                </tr>
    ...
    <a id="back-to-top" data-toggle="tooltip" data-placement="auto" title="Back-to-Top" style="color:orange;background-color:whitesmoke;border:2px solid black;" href="#" class="btn-light btn-lg back-to-top" role="button"><i class="fas fa-arrow-up"></i></a>
