...
<meta charset="UTF-8">
    ...
    /* Main Footer */
    footer .main-footer{font-family: 'Acme';box-shadow: -3px -3px 5px black;	padding: 20px 0;	background: green;    border-top: 2px solid black;}
    ...
    /* Footer Top */
    .footer-top{	background: orange;	padding-bottom: 30px;	margin-bottom: 30px;	border-bottom: 3px solid #222;}
...
<footer style = "font-size : 18px;" id="footer" class="footer-1">
    ...
    <p style= "color : #D0D3D4;"><a href="mailto:info@bmsce.ac.in" title="glorythemes" style="color:white;"><i class='far fa-envelope' style='font-size:14px'></i> info@bmsce.ac.in</a></p>
