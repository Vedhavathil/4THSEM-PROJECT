...
<body>
   ...
   <div class = "col-lg-6 m-auto mcon" style = "border-radius: none;">
      <h1 style = "color : Navy;font-size:45px;letter-spacing: 2px;padding-bottom:0px;padding-top:15px;margin-top:1px;font-weight:bold;text-shadow:1px 1px 2px black;" align="center"></strong>INSTRUCTIONS</strong></h1>
      ...
      1. First Students Has To Register By Filling Out The Registration Form which contains basic details 
      Like (USN, Name, Mobile, Email, & Set The Password..)<br/>
      2. After Registering Go To Login Page  <br /> 3. Enter The Login Details Which You Have entered During the time of Registration.<br / >
      4. Once Login is Successful-> Choose The Exam You Want To Appear.<br />
      5. Select Your Respective Department.<br />
      6. Select The Semester.<br />
      7. Then Finally Select The Subjects and register for Examination.<br/>
      </p>
